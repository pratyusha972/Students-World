...
public class LoginActivity extends Activity {
    ...
    public void invokeWS(JSONObject params){
        ...
        client.post(getApplicationContext(),"http://10.0.2.2:8081/useraccount/login/dologin",entity,"application/json" ,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if(obj.getBoolean("status")){
                        ...
                        edit_login.commit();
                        edit_login.putInt("uid",obj.getInt("user_id"));
